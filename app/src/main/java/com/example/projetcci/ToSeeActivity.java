...
public class ToSeeActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toolbar toolbar = findViewById(R.id.toolbar_to_see);
        ...
        NavigationView navigationView = findViewById(R.id.nav_view_to_see);
        navigationView.setNavigationItemSelectedListener(this);

        moviesView = (RecyclerView) findViewById(R.id.movies_list_to_see);
